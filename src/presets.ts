...
export const DEFAULT_PRESETS: Preset[] = [
  {
    ...
    description: '45 LPI round screen with 2px choked underbase. Preserves 100% full-color artwork with breathable dots.',
    settings: {
      lpi: 45,
      angle: 45,
      shape: 'round',
  ...
  {
    id: 'dtf-knockout-black',
    name: 'DTF Black Shirt Knockout',
    description: '45 LPI screen knocking out black ink to let dark garment fabric show through.',
    settings: {
      lpi: 45,
      angle: 45,
      shape: 'round',
